...
/**
 * A basic sample which shows how to use {@link com.example.android.common.view}
    ...
    class BarsPagerAdapter extends FragmentPagerAdapter {
       ...
       /* @Override
        ...
        public CharSequence getPageTitle(int position) {
            return mBarsType.get(position).getTitle();
        }
       ...
       /* @Override
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Fragment fragment= new ElectronicBarFragment();
