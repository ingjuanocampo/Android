 ...
 */
public class FragmentDiscos extends Fragment implements OnClickBarItem,View.OnClickListener{
    ...
    public static FragmentDiscos newInstance(String category) {
        FragmentDiscos fragment = new FragmentDiscos();
    ...
    private void populateRecyclerView() {
        ...
        HandlerProvider.getProvider().getBars(ProviderBase.DiscoCategory, new OnProviderResponse() {
            ...
            public void onSucessResponse(Object responce) {
                ...
                mAdapter = new RecyclerAdapterDiscos(mBars, FragmentDiscos.this, mViewContainer.getContext());
