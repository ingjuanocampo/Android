...
import partyup.com.myapplication.Adapters.RecyclerAdapterRestaurant;
 ...
 */
public class FragmentRestaurant  extends Fragment implements OnClickBarItem,View.OnClickListener{
    ...
    public static FragmentRestaurant newInstance(String category) {
    ...
    private void populateRecyclerView() {
        ...
        HandlerProvider.getProvider().getBars(ProviderBase.RestauranCategory, new OnProviderResponse() {
            @Override
            public void onSucessResponse(Object responce) {
                ...
                mAdapter = new RecyclerAdapterRestaurant(mBars, FragmentRestaurant.this, mViewContainer.getContext());
