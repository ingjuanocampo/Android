...
import partyup.com.myapplication.Objects.Bars;
...
public class FragmentMap extends Fragment implements GoogleMap.OnMyLocationChangeListener{
    ...
    private LatLng mLantLng;
    ViewGroup mContanier;
    View rootView;

    private LocationManager locationManager;
    private Location mLocation;
    private Bars mBars= new Bars();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("FragmentMap", "onCreateView");
    ...
    private void setUpMapIfNeeded(View rootView) {
       ...
       /* SupportMapFragment fm = (SupportMapFragment) MyActivity.getSupportFragmentManager()
        ...
        this.mMap.getUiSettings().setScrollGesturesEnabled(true);
         ...
         mMap.setOnMyLocationChangeListener(FragmentMap.this);
    ...
    public void onMyLocationChange(Location location) {
        ...
        try {
            ...
            Log.w("onLocationChanged","fail to get location");
        }
